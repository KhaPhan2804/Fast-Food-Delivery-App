...
export default function DishRow({item}) {
  ...
  return (
    <TouchableWithoutFeedback onPress={() => navigation.navigate('Row',{...item})}>
      <View className="flex-row items-center p-3 rounded-3xl shadow-2xl mb-3 mx-2" style={{backgroundColor:themeColors.bgColor(0.2)}}>
